...
// When the 2 second timer finishes, the test will fail, so checks it takes under 2 seconds.
    test(
    ...
    test('Should be able to log out and log back in again', () async {
...
class MockAuthProvider implements AuthProvider {
  // Underscores on variables mean private variables
  AuthUser? _user;
